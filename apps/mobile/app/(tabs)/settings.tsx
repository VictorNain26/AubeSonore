    ...
    >
      ...
      >
        <Ionicons
          name={icon}
          size={18}
          color={destructive ? '#ef4444' : 'rgba(255,255,255,0.6)'}
        />
      </View>
...
function Section({ title, children }: SectionProps) {
  return (
    <View className="mb-6">
      <Text className="text-xs text-white/40 uppercase tracking-wider px-4 mb-2">
        {title}
      </Text>
      ...
      >
        ...
        <Section title="À propos">
          ...
          <SettingItem
            ...
            title="Version"
            rightElement={
              <Text className="text-sm text-white/40">{appVersion}</Text>
            }
          />
        </Section>
        ...
        <View className="items-center py-8">
          <Text className="text-xs text-white/20">
            Aube Sonore © {new Date().getFullYear()}
          </Text>
